<?php
require("images/functions.php");
require("images/image_functions.php");
require("database/init.php");
//require("database/init.php");

$img = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQGHvIcfFjiJsvHdeVjjpszdHRWdw6I5JFsOIq5zrCO2gF4TJ405Q&s";
...
add_user("CYKO","makingdatabases@wethinkcode.he.he",NULL,"ilovewaifucocks");
