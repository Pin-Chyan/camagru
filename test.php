...
echo "\nadd comment\n\n";
$comm = new comments();
$comm->add_comment("1","1","is that kirito?");
$comm->add_comment("2","2","senpai is kawaii!");
$comm->add_comment("3","3","bananas");
$comm->add_comment("4","4","this movie broke me!");
$comm->add_comment("2","4","i am heartless");
$comm->add_comment("3","2","bananas");
echo "\nremove comment test\n\n";
$comm->remove_comment("1","1");
$comm->remove_comment("2","2");
// remove_comment("3","3");
// remove_comment("4","4");
$comm->remove_comment("2","4");
$comm->remove_comment("3","2");
?>